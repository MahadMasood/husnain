    ...
    <div className="h-full w-full">
      ...
      >
        <Card>
          ...
          <Image src="/hero/hero1.jpg" alt="Protocol 1" width={800} height={500} />
        </Card>
        <Card>
          <h3 className="text-white font-mono text-lg mb-2">PROTOCOL_02</h3>
          <Image src="/hero/hero2.jpg" alt="Protocol 2" width={800} height={500} />
        </Card>
        <Card>
          <h3 className="text-white font-mono text-lg mb-2">PROTOCOL_03</h3>
          <Image src="/hero/hero3.jpg" alt="Protocol 3" width={800} height={500} />
        </Card>
      </CardSwap>
    </div>
  );
